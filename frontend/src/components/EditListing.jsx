...
const handleSubmit = async (event) =>
{
  ...
  try
  {
    const response = await axios.put(`${BASE_URL}/api/listing/edit-listing/${id}`, formData)
...
// console.log(images);
  ...
  return (
   <>
      ...
      {listing && <div className="formcontainer" style={{marginLeft:"10%", marginRight:"10%", marginTop:"5%", overflow: "hidden"}}>
          ...
          <div className="col"> <h1 className="text-center font-weight-bold" >Property Name: {listing.name} </h1> </div>
          </div>
          ...
          <div className="col-lg-4"> <h1 className="text-start font-weight-bold" >Zip code: {listing.postalCode}</h1> </div>
          ...
          <div className="col-sm-2 text-center">
            <h1 className="text-start font-weight-bold" >Bathrooms: {listing.bathroom}</h1>
          </div>
          ...
          <div className="col-sm-2 text-center">
            <h1 className="text-start font-weight-bold" >Bedrooms: {listing.bedroom}</h1>
          </div>
          <div className="col-sm-1 ml-0" style={{marginTop:"2%"}}>
          ...
          <div className="col-sm-2 text-center">
            <h1 className="text-start font-weight-bold" >Pricing: {listing.price}</h1>
          </div>
